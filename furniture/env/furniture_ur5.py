""" Define Ur5 environment class FurnitureUr5Env. """
...
class FurnitureUr5Env(FurnitureEnv):
    """
    Ur5 environment.
    """
...
def main():
    ...
    parser = create_parser(env="FurnitureUr5Env")
    ...
    # create an environment and run manual control of Ur5 environment
    env = FurnitureUr5Env(config)
